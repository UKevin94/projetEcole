...
public class MaClasseDeTest{
	...
	public void premierTest() throws AgeEleveException{
		...
		//instanciation de l'objet eleve a partir du constructeur
		Eleve eleve = new Eleve("Dusser", "Quentin", 9);
		
		//renseigne la variable absent par l'intermediaire du setter
		eleve.setAbsent(false);
		
		//Affiche en console l'etat de l'eleve e1
		System.out.println("L'eleve 'e1' est-il absent ? ---> "+ eleve.getAbsent());
		
		//verifie la bonne valorisation du setter
	...
	public void presentationEnseignantPA(){
		System.out.println("\ndeuxieme test".toUpperCase());
		 ...
		 // test methode augmenter salaire
...
//exercice 8	
	...
	public void presentationStaffTest() {
		...
		Enseignant enseignant2 = new Enseignant("Corbiere", "Janette");
